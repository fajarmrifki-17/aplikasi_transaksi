...
@section('title', 'Proses Persetujuan Transaksi')
@section('page-title', 'Proses Persetujuan')
    ...
    <div class="col-12 col-lg-8">
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
            <div class="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
                ...
                <span class="badge-status badge-waiting-supervisor fs-6">{{ $submission->status }}</span>
            </div>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            ...
            <div class="card-body p-4 border-top">
                <form id="approvalForm" method="POST" action="{{ route('approvals.action', $submission) }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="notes" id="notes" class="form-control bg-light @error('notes') is-invalid @enderror" rows="4" placeholder="Tulis catatan persetujuan Anda..." required></textarea>
